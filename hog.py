...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0<goal and score1<goal:
        #Test if Player 0's turn
        if who==0:
            number_rolls = strategy0(score0,score1)
            score0 += take_turn(number_rolls, score1, dice=six_sided)
            if extra_turn(score0,score1):
                return
            who = other(who)
        else:
            number_rolls = strategy1(score1,score0)
            score0 += take_turn(number_rolls, score0, dice=six_sided)
